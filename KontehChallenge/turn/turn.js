  ...
  $.fn.fold = function(options) {
    ...
    */
    ...
    var defaults = {
      ...
      turnImage: 'turn/fold.png',  // The triangle-shaped fold image
      maxHeight: 400,         // The maximum height. Duh.
      startingWidth: 0,     // The height and width 
      startingHeight: 0,    // with which to start (these should probably be camelCase, d'oh.)
    ...
    if (options.side == 'right' && !options.turnImage) defaults.turnImage = 'turn/fold-sw.png';
